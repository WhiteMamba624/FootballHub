...
import com.gligamihai.footballhub.Utils.JsonParser;
...
public class PlacesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] placeTypeList = {"stadium", "gas_station","gym"};
        String[] placeNameList = {"Stadiums", "Gas station","Gyms"};
